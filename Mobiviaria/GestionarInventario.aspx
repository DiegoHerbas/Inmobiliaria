    ...
    <form id="form1" runat="server">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateColumn HeaderText="Acciones">
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:ImageButton id="tapiafoto" runat="server" CommandName="FOTO" ImageUrl="~/iconos/photo.png"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-xs-12">
                                             <%--   <div class="form-group">--%>
                                                   <%-- <asp:UpdatePanel runat="server">
                                                        <ContentTemplate>--%>
                                                            <asp:Image ID="imgImagen" BorderWidth="1px" Height="205px" Width="205px" runat="server" />
                                                      <%--  </ContentTemplate>
                                                    </asp:UpdatePanel>--%>
                                             <%--   </div>--%>
                                            </div>
                ...
                <asp:HiddenField ID="photo_name" Value="0" runat="server" />
            </section>
        </div>
    </form>
</asp:Content>
